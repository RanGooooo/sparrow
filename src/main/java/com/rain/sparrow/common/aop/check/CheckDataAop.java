...
import com.rain.sparrow.common.constant.SystemExceptionConstant;
import com.rain.sparrow.common.exception.SystemException;
...
public class CheckDataAop {
    ...
    @Pointcut("execution(* com.rain.sparrow..*.*(@com.rain.sparrow.common.annotation.check.CheckData (*), ..))")
