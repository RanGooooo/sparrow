package com.rain.sparrow.develop.code.service.sdk;
...
public class LiberateHand {
	...
	public void copyFileContextImpl(String source, String target) {
		FileReader fr = null;
	...
	public void copyFileContext() throws IOException {
		int i = 0;
	...
	public LiberateHand build() throws IOException {
		this.newFile();
