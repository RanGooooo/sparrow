 ...
 */
(function(jQuery) {
    let $, Collapser, JSONFormatter, JSONView, JSON_VALUE_TYPES;
  ...
  JSONFormatter = (function() {
    ...
    JSONFormatter.prototype.stringToHTML = function(value) {
        let multilineClass, newLinePattern;
    ...
    JSONFormatter.prototype.arrayToHTML = function(array, level) {
      let collapsible, hasContents, index, numProps, output, value, _i, _len;
      if (level === null) {
        level = 0;
      }
      hasContents = false;
    ...
    JSONFormatter.prototype.objectToHTML = function(object, level) {
        let collapsible, hasContents, key, numProps, output, prop, value;
      if (level === null) {
        level = 0;
      }
      hasContents = false;
  ...
  Collapser = (function() {
    ...
    Collapser.toggle = function(collapser, options) {
        let action, collapsers, target, _i, _len, _results;
      if (options == null) {
        options = {};
      }
      target = this.collapseTarget(collapser);
  ...
  return $.fn.JSONView = function() {
      let args, defaultOptions, formatter, json, method, options, outputDoc;
    args = arguments;
    if (JSONView[args[0]] !== null) {
      ...
      return this.each(function() {
          let $this, item, items, _i, _len, _results;
        $this = $(this);
        $this.html(outputDoc);
